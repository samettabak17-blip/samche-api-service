...
async function bootstrapTask8Demo(options = {}) {
  ...
  try {
    ...
    const personaOutcome = await ensureTenantWebChatPersona({
      ...
      language: 'en',
      demoMode: task8DemoModeConfig,
      supportEmail: 'support@samche.com',
      supportPhone: '+971 50 694 1372',
      ...
      supportEscalationRules: 'Explicit customer request for live agent triggers operator handoff. Private order queries should be guided to email support@samche.com or their confirmation tracking link.',
      rules: [
        ...
        'SUPPORT HOURS & CHANNELS: Customer Care Desk operates daily from 8:00 AM to 10:00 PM GST. Support email: support@samche.com, phone: +971 50 694 1372. Regional dispatch and returns center: Dubai Central Fulfillment Hub, UAE.',
        'UNKNOWN PRIVATE STATE / ORDER STATUS: Live individual order databases and credit card transactions cannot be accessed directly in chat for customer security and privacy. When a customer asks for live order tracking, status, or balance, state clearly that live order records cannot be accessed directly in chat, remind them of standard 1-2 day delivery (or same-day if before 2 PM), and instruct them to use the tracking link in their email confirmation or email support@samche.com with their Order ID.',
