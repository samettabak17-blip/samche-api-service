...
(function(global) {
  ...
  var CANONICAL_WIDGET_CSS_A = [
    ...
    '.samche-launcher.samche-style-circular { width: 60px !important; height: 60px !important; min-width: 60px !important; min-height: 60px !important; max-width: 60px !important; max-height: 60px !important; border-radius: 50% !important; padding: 0 !important; box-sizing: border-box !important; background-color: var(--chat-launcher-bg, #0F172A) !important; background: var(--chat-launcher-bg, radial-gradient(circle at center, rgba(30, 41, 59, 0.9) 0%, rgba(2, 6, 23, 0.98) 100%)) !important; border: 1px solid var(--chat-launcher-border, var(--chat-glow-ring, rgba(56, 189, 248, 0.85))) !important; color: var(--chat-launcher-text, #FFFFFF) !important; box-shadow: 0 0 calc(var(--chat-glow-spread, 24px) * 0.6) var(--chat-launcher-border, var(--chat-glow-ring, rgba(56, 189, 248, 0.8))), 0 0 var(--chat-glow-halo, 42px) var(--chat-launcher-glow, var(--chat-glow, rgba(56, 189, 248, 0.45))), 0 10px 30px -4px var(--chat-glow-soft, rgba(56, 189, 248, 0.25)), 0 4px 18px rgba(0, 0, 0, 0.4); }',
