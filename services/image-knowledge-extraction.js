...
const IMAGE_MIME_TYPES = Object.freeze({
  ...
  'image/webp': Object.freeze({ extensions: new Set(['webp']), signature: (bytes) => bytes.length >= 12 && bytes.subarray(0, 4).toString('ascii') === 'RIFF' && bytes.subarray(8, 12).toString('ascii') === 'WEBP' }),
});
