...
test('public Guide bootstrap resolves presentation from the canonical active hostname binding, never browser tenant input', () => {
  ...
  assert.match(source, /guideSessionScope\(scope\)/);
});
