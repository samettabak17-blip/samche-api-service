...
export interface GuideDomain { id: string; tenant_id: string; assistant_id: string; channel_id: string; hostname: string; status: GuideDomainStatus; verification_record_type: 'CNAME'; verification_target: string; verified_at?: string | null; activated_at?: string | null; archived_at?: string | null; created_at?: string; }
