...
export function ConversationsPage() {
  ...
  return <div className="space-y-5">
    <header className="flex items-end justify-between gap-4"><div><p className="eyebrow">Live customer inbox</p><h1 className="page-title mt-2">Conversations · {channelContext.label}</h1><p className="mt-2 text-sm text-stone-400">Real tenant channel activity and human handoff controls.</p></div><LiveState state={liveState} /></header>
