...
export function ConversationsPage() {
  ...
  if (conversationsQuery.isError && !debouncedSearch) return <QueryErrorState error={conversationsQuery.error} onRetry={() => void conversationsQuery.refetch()} resource="conversations" />;
