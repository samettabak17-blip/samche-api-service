...
import { Bot, ChevronLeft, ChevronRight, Download, ExternalLink, FileText, Headphones, Image as ImageIcon, MessageSquareText, Send, UserRound } from 'lucide-react';
...
export function ConversationsPage() {
  ...
  const openAttachment = async (resourceId: string, download: boolean) => {
    if (!conversationId) return;
    setAttachmentError(null);
    try {
      const blob = await tenantApi.getConversationAttachment(tenantId, conversationId, resourceId, download);
