...
beforeEach(() => {
  ...
  api.listGuideDomains.mockResolvedValue([{ id: 'domain-a', tenant_id: 'tenant-a', assistant_id: 'assistant-a', channel_id: 'channel-a', hostname: 'guide.tenant.example', status: 'PENDING', verification_record_type: 'CNAME', verification_target: 'ingress.example' }]);
});
