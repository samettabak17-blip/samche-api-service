...
export function LoginPage() {
  ...
  return <AuthVisualLayout>
          ...
          <form className="auth-login-form mt-7 space-y-4" onSubmit={submit} noValidate>
            ...
            <DashboardButton type="submit" variant="primary" disabled={submitting} className="auth-button-primary w-full mt-6 text-sm"><LockKeyhole aria-hidden="true" size={15} /><span>{submitting ? 'Signing in…' : 'Sign in'}</span><ArrowRight aria-hidden="true" size={16} /></DashboardButton>
          </form>
