...
export const tenantApi = {
  ...
  listGuideDomains: (tenantId: string, assistantId: string) => apiClient.get<{ domains: import('../../types/api').GuideDomain[] }>(`${tenantRoot(tenantId)}/guide-experiences/assistants/${assistantId}/domains`).then((value) => value.domains),
