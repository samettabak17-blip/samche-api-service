...
export const tenantApi = {
  ...
  createGuideDomain: (tenantId: string, assistantId: string, body: { hostname: string; channel_id: string }) => apiClient.post<{ domain: import('../../types/api').GuideDomain }>(`${tenantRoot(tenantId)}/guide-experiences/assistants/${assistantId}/domains`, body).then((value) => value.domain),
