...
export const tenantApi = {
  ...
  generateImageKnowledgeCandidates: (tenantId: string, sourceId: string, payload: { assistantId?: string | null; extractionHash?: string | null }) => apiClient.post<{ candidates: KnowledgeCandidate[]; reused: boolean }>(`${tenantRoot(tenantId)}/knowledge-intelligence/sources/${sourceId}/candidates/generate`, { assistant_id: payload.assistantId ?? null, extraction_hash: payload.extractionHash ?? undefined, candidate_type: 'POLICY' }),
