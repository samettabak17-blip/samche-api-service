...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  return <LiveSupportAttentionProvider tenantId={selectedTenant.id} userId={user.id}><div className="min-h-screen bg-canvas lg:grid lg:grid-cols-[18rem_1fr]">
