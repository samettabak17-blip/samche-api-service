...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  return <LiveSupportAttentionProvider tenantId={selectedTenant.id} userId={user.id}><OverviewDateRangeProvider><div className="dashboard-shell min-h-screen min-h-[100dvh] w-full min-w-0 bg-canvas lg:grid lg:grid-cols-[13rem_minmax(0,1fr)]">
