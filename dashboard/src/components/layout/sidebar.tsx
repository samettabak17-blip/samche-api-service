...
export function Sidebar({ tenantId, tenantName, tenantRole, email, onLogout, onNavigate }: SidebarProps) {
  ...
  return <aside className="flex h-full w-full flex-col border-r border-line/80 bg-shell/95 px-2.5 py-5 text-white">
    <div className="mb-6 px-2.5"><img src={samcheLogo} alt="SamChe Company LLC" className="h-20 w-44 max-w-full object-contain object-left sm:h-20 sm:w-48" /><p className="mt-1 text-[9px] font-semibold uppercase tracking-[0.24em] text-stone-400">AI Platform</p></div>
